...
public class AppProperties { 
	...
	private static AppProperties self = null; //declaring a private class variable and assigning it to null
	private Properties properties; //declaring a private variable

//Class method is created to take input from parameter, perform action and give a reuslt
public static AppProperties getInstance() { //factory method use for singleton class creation
...
private AppProperties() {properties = new Properties();
	...
	catch (IOException e) {throw new RuntimeException("Could not read property file");}} // For catching any error using exception for handling it 

public Properties getProperties() {return properties; //returns properties
}}
